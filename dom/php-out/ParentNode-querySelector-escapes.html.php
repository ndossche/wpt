...
$content = file_get_contents(__DIR__."/../nodes/ParentNode-querySelector-escapes.html");
$document = Dom\HTMLDocument::createFromString($content);
;
"use strict";
;
function testMatched($id, $selector) {
  test(function() use ($id, $selector) { global $document;
